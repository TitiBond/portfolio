  ...
  <body class="min-h-screen bg-main-color">
    ...
    <div class="mx-auto max-w-5xl">
      ...
      >
        ...
        <p class="mt-8">
          Dans le cadre de ma reconversion, je poursuis mes études en licence
          "Developpeur Web Mobile". Je suis donc à la recherche d'un contrat de
          professionnalisation d'une durée de 1 an.
        </p>
      </section>
    </div>
    <div class="my-16 bg-grey-color py-16">
      ...
      >
        ...
        <div class="md:px-10 md:text-justify md:w-2/3">
          ...
          <p>
            J'ai toujours été attiré par l'informatique, le multimédia, la
            technologie... Quand j'étais plus jeune, je me souviens encore
            passer des heures devant mon écran afin de modder,voire parfois
            débuguer des jeux pour leur ajouter du contenu. Je prenais du
            plaisir à ça. <br />
            Il y avait un truc... Ce petit truc de logique qui rend presque
            accro. <br />
            Pourtant mes choix ne m'ont pas orienté sur ce chemin là. <br />
            Je suis cependant persuadé que nous aspirons tous à faire un travail
            qui nous correspond, qui nous plait. <br />
            C'est pour cela qu'à 35 ans, j'ai décidé de me reconvertir, et de
        ...
        >
          ...
          >
            ...
            >
              ...
              <p class="m-2 mb-4 text-center">
                Ma première expérience fut une start-up : "Splitted Desktop
                System". <br /><br />
                J'ai commencé par faire de la maintenance Hardware et Software
                sur leur marque d'ordinateur. <br /><br />
                Mais ma curiosité m'a vite permis de toucher à tout : <br />
                Du web, en passant par de l'électronique, jusqu'à la logistique
                !
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <p class="m-2 mb-4 text-center">
                ...
                Suite à des problèmes de trésorerie, je quitte l'entreprise et
                décide d'essayer autre chose.<br /><br />
                Je passe un diplôme d'auxiliaire ambulancier.
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <p class="m-2 mb-4 text-center">
                ...
                <br /><br />
                Tres belle expérience qui m'a apporté beaucoup sur le plan
                humain !
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <p class="m-2 mb-4 text-center">
                ...
                Je passe 5 années en tant que conducteur-receveur. <br /><br />
                Tourisme, transport scolaire, entreprise privée, ligne
                régulière. <br /><br />
          ...
          >
            ...
            >
              ...
              <p class="m-2 mb-4 text-center">
                ...
                Aujourd'hui, je suis à la "Coding Factory" pour obtenir un
                diplome BAC+2 de développeur informatique.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <p>
              ...
              jeu de mémoire basé sur le Memory. L'idée était de mélanger cela
              avec des images d'un jeu de société que j'adore "Twin it!". Nous
              avons eu 2 jours pour réaliser ce projet.
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <p>
              Quiz Android est un petit projet que nous avons réalisé en 2
              jours. Nous avons utilisé
              <span class="text-main-green">JAVA</span>. Vraiment interessant de
              découvrir la création d'application smartphone. Notre semaine sur
              <span class="text-main-green">Android</span> n'a duré que 4 jours,
              j'aurais adoré avoir plus de temps !
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <p>
              ...
              réfléchir à la logique du script :)
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <p>
              La caverne des jeux est un projet réalisé dans le cadre du cours
              de <span class="text-main-green">PHP</span> à la Coding Factory.
          ...
          >
            <div id="flip_card_front" class="absolute h-full w-full">
              <p class="text-lg">
                ...
                Parfait ! Je suis à la recherche d'un contrat de
                professionnalisation d'une durée de 1 an afin de poursuivre ma
                reconversion en Licence. Licence qui s'effectuera de octobre
                2023 à juin 2024. <br /><br />
